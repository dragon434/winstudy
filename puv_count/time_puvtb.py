...
import xlrd
from pyecharts import Bar, Page, Line, Grid

# 创建一个页面
page = Page()

# excel
data = xlrd.open_workbook('E:\lrzsz\sz\\account_ekeguan_com201809.xlsx')
www = xlrd.open_workbook('E:\lrzsz\sz\\www_ekeguan_com201809.xlsx')
table = data.sheets()[0]
bank = www.sheets()[0]
...
bar = Line("account_ekeguan_com_25号_时间段", height=350)
...
line = Line("www_ekeguan_com_25号_时间段", title_top='1%')
